...
export default function Page({ params }) {
  const { slug } = params; // Ensure params is correctly passed from the routing setup
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">PERFUME</h2>
              <h1 className="text-gray-900 text-3xl font-serif title-font font-medium mb-1">
                Eternal Blossom
              </h1>
              ...
              <div className="flex">
                <span className="title-font font-medium text-2xl text-gray-900">Rs 1500.00</span>
                <button className="flex ml-auto font-serif text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded">
                  Add to Cart
                </button>
